...
enum ProofBlindingAction {
  ...
  static ProofBlindingAction fromValue(dynamic value) =>
      ProofBlindingAction.values
          .where(
            (element) => element.value == value,
          )
          .firstOrNull ??
      ProofBlindingAction.unknown;
  ...
  static UnblindingData fromMap(Map<String, Object?> map) {
    ...
    return UnblindingData(
      ...
      actionType: ProofBlindingAction.fromValue(
        Tools.getValueAs<int>(
            map, 'actionTypeRaw', ProofBlindingAction.unknown.value),
      ),
...
extension UnblindingDataDriftExtension on UnblindingData {
  /// Convert UnblindingData model to Drift table companion for inserting/updating
  CashuUnblindingDataTableCompanion toCompanion() {
    return CashuUnblindingDataTableCompanion.insert(
      mintURL: mintURL,
      unit: unit,
      actionTypeRaw: actionType.value,
      actionValue: actionValue,
      ...
      amount: amount,
      C_: C_,
      dleqPlainText: Value<String>(dleqPlainText),
      r: r,
      secret: secret,
    );
  }

  /// Create UnblindingData model from Drift table data
  static UnblindingData fromTableData(CashuUnblindingDataTableData data) {
    return UnblindingData.fromMap({
