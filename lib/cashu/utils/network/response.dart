enum ResponseCode {
  ...
  static ResponseCode fromValue(int value) {
    return ResponseCode.values.where((e) => e.value == value).firstOrNull ??
        ResponseCode.failed;
  }
}
  ...
  Set<String> get subErrorText {
    switch (this) {
      ...
      case ResponseCode.failed:
        return {};
      case ResponseCode.notAllowedError:
        return {};
      case ResponseCode.transactionError:
        return {};
      case ResponseCode.tokenAlreadySpentError:
        return {
          'Token already spent',
        };
      case ResponseCode.secretTooLongError:
        return {};
      case ResponseCode.noSecretInProofsError:
        return {};
      case ResponseCode.keysetError:
        return {};
      case ResponseCode.keysetNotFoundError:
        return {};
      case ResponseCode.lightningError:
        return {};
      case ResponseCode.invoiceNotPaidError:
        return {
          'quote not paid',
        };
    }
...
class CashuResponse<T> {
  ...
  factory CashuResponse.fromErrorMap(Map map) {
    ...
    return CashuResponse(code: code, errorMsg: map['detail'] ?? '');
  }
