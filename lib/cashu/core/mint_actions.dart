...
import 'nuts/v0/nut.dart' as v0;
import 'nuts/v1/nut.dart' as v1;

typedef RequestKeysAction = Future<CashuResponse<List<MintKeysPayload>>>
    Function({
...
typedef TokenSwapAction = Future<CashuResponse<List<BlindedSignature>>>
    Function({
  required String mintURL,
  required List<Proof> proofs,
...
typedef RequestTokensAction = Future<CashuResponse<List<BlindedSignature>>>
    Function({
  required String mintURL,
...
extension ActionEx on IMint {
  RequestKeysAction get requestKeysAction =>
      maxNutsVersion >= 1 ? v1.Nut1.requestKeys : v0.Nut1.requestKeys;

  RequestMintInfoAction get requestMintInfoAction =>
      maxNutsVersion >= 1 ? v1.Nut6.requestMintInfo : v0.Nut9.requestMintInfo;

  TokenCheckAction get tokenCheckAction => maxNutsVersion >= 1
      ? v1.Nut7.requestTokenState
      : v0.Nut7.requestTokenState;

  TokenSwapAction get swapAction =>
      maxNutsVersion >= 1 ? v1.Nut3.swap : v0.Nut6.split;
